...
$tests = [
    ...
    'SQL static audit console contract'     => __DIR__ . '/test_sql_static_audit_console.php',
    'SQL static audit suite contract'       => __DIR__ . '/test_sql_static_audit_suite.php',
    ...
    'Declarative suite machine result'      => __DIR__ . '/test_run_suite_config_machine_result_contract.php',
